        ...
        <div className={styles.container}>
          <div className={styles.newsletterContent}>
            <div className={styles.newsletterText}>
              ...
              <p>Recevez nos offres exclusives et nos dernières réalisations</p>
            </div>
          ...
          <div className={styles.footerGrid}>
            ...
            <div className={styles.footerColumn}>
              <div className={styles.logo}>
                <span className={styles.logoText}>Glory</span>
                <span className={styles.logoAccent}>Event</span>
              </div>
              <p className={styles.tagline}>{COMPANY_INFO.tagline}</p>
              <p className={styles.description}>
                Votre partenaire de confiance pour l'organisation d'événements
                d'exception et la vente de parfums de luxe.
              </p>
