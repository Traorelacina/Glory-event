...
import logo from '../images/logo_event.jpg'; // Import de l'image
...
export default function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  return (
    <>
              ...
              <div className="relative w-12 h-12 transform transition-transform group-hover:scale-110">
                <img
                  ...
                  onError={(e) => {
                    ...
                    fallback.className = 'w-12 h-12 bg-gradient-to-br from-[#8B5CF6] to-[#EC4899] rounded-lg flex items-center justify-center';
      ...
      {/* Espace réservé pour éviter que le contenu soit caché sous le header */}
